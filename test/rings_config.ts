...
export const ringsInfoList: RingsInfo[] = [
    ...
    orders: [
      {
        ...
        tokenS: "STA",
        trancheS: "0x" + "ab".repeat(32),
        transferDataS: "0x" + "ab".repeat(100),
        tokenTypeS: TokenType.ERC1400,
        tokenB: "WETH",
        amountS: 3e18,
        amountB: 1e18,
      ...
      },
      {
        ...
        tokenS: "STA",
        trancheS: "0x" + "ab".repeat(32),
        transferDataS: "0x" + "cd".repeat(100),
        tokenTypeS: TokenType.ERC1400,
        tokenB: "WETH",
        amountS: 3e18,
        amountB: 1e18,
  ...
  {
    description: "single 2-size ring, selling ERC1400 token to different tranche",
    rings: [[0, 1]],
    orders: [
      {
        tokenS: "WETH",
      ...
      },
      {
        ...
        transferDataS: "0x00" + "01".repeat(32),           // destination tranche in transfer data (TOKEN SPECIFIC!)
      },
    ],
    expected: {
      rings: [
